...
$min_cachePath = dirname(__DIR__) . '/protected/runtime';
 ...
 */
function yuiJs($js) {
    Minify_YUICompressor::$jarFile = __DIR__ . '/lib/yuicompressor-2.4.8.jar';
    Minify_YUICompressor::$tempDir = dirname(__DIR__) . '/protected/runtime';
